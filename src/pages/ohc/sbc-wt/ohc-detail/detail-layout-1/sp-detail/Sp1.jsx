  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-9 gap-2 mt-4">
      <div className="lg:col-span-4 bg-white rounded-lg">
        ...
        <div>
          <img
            src="https://images.unsplash.com/photo-1657897392470-2fbc02127098?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fHdlbGRpbmclMjBtYWNoaW5lfGVufDB8fDB8fHww"
            alt=""
